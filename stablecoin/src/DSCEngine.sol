...
contract DSCEngine is ReentrancyGuard {
    ...
    */
    ...
    function getDepositedCollateralAmountOfUser(address user, address collateralToken) public view returns(uint256) {
        return collateralDeposits[user][collateralToken];
    }
}
